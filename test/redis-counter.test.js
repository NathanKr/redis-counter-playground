...
describe("counter tests", () => {
  ...
  test('increment is incrementing by 1',async () =>{
    ...
    await client.setValueTo1("key7" , expiredTimeSec);
  ...
  test('exist return 1 on exist',async () =>{
    const expiredTimeSec = 100; // very long
    await client.setValueTo1("key5" , expiredTimeSec);
  ...
  test('get is working correctly with setValueTo1 not expire',async () =>{
     const expiredTimeSec = 100; // very long
     await client.setValueTo1("key3" , expiredTimeSec);
     const value = await client.get("key3");
     expect(value).toBe(1);
  })

test('exist is working correctly with setValueTo1 expire',async () =>{
    const expiredTimeSec = 2; // short
    await client.setValueTo1("key4" , expiredTimeSec);
 ...
 test('exist is working correctly with setValueTo1 not expire',async () =>{
    const expiredTimeSec = 100; // long
    await client.setValueTo1("key6" , expiredTimeSec);
  ...
  test("negative expired time do not return OK", async () => {
    ...
    let result;
    try {
        result = await client.setValueTo1("key1", expiredTimeSec);
    } catch (error) {
        result = error;
    }
  ...
  test("positive expired time return OK", async () => {
    ...
    const result = await client.setValueTo1("key2", expiredTimeSec);
